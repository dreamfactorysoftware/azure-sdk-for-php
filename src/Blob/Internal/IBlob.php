...
interface IBlob extends FilterableService
{
	 ...
	 *
	 * @param BlobServiceOptions $options optional blob service options.
	 *
	 ...
	 *
	 * @param ListContainersOptions $options optional parameters
	 *
	 ...
	 * @param CreateContainerOptions $options   optional parameters
	 *
	 * @return void
	 *
	 ...
	 *
	 * @param string                 $container name
	 * @param DeleteContainerOptions $options   optional parameters
	 *
	 * @return void
	 *
	 ...
	 * @param SetContainerMetadataOptions $options   optional parameters
	 *
	 * @return void
	 *
	 ...
	 *
	 * @param string           $container name
	 * @param ListBlobsOptions $options   optional parameters
	 *
	 ...
	 * @param string                 $container        name of the container
	 * @param string                 $blob             name of the blob
	 * @param PageRange              $range            Can be up to the value of the
	 *                                                 blob's full size.
	 ...
	 * @param string                 $container name of the container
	 * @param string                 $blob      name of the blob
	 * @param PageRange              $range     Can be up to 4 MB in size
	 ...
	 * @see http://msdn.microsoft.com/en-us/library/windowsazure/ee691975.aspx
	 */
	public function createBlobPages( $container, $blob, $range, $content, $options = null );
	 ...
	 * @param CreateBlobBlockOptions $options          optional parameters
	 *
	 * @return void
	 *
	 ...
	 * @param string                  $container name of the container
	 * @param string                  $blob      name of the blob
	 * @param BlockList               $blockList the block list entries
	 * @param CommitBlobBlocksOptions $options   optional parameters
	 *
	 * @return void
	 *
	 ...
	 * @param string                $container name of the container
	 * @param string                $blob      name of the blob
	 * @param ListBlobBlocksOptions $options   optional parameters
	 *
	 ...
	 * @param string                   $container name of the container
	 * @param string                   $blob      name of the blob
	 * @param GetBlobPropertiesOptions $options   optional parameters
	 *
	 ...
	 * @param string                 $container name of the container
	 * @param string                 $blob      name of the blob
	 * @param GetBlobMetadataOptions $options   optional parameters
	 *
	 ...
	 * @param string                    $container name of the container
	 * @param string                    $blob      name of the blob
	 * @param ListPageBlobRangesOptions $options   optional parameters
	 *
	 ...
	 * @param string                   $container name of the container
	 * @param string                   $blob      name of the blob
	 * @param SetBlobPropertiesOptions $options   optional parameters
	 *
	 ...
	 * @param SetBlobMetadataOptions $options   optional parameters
	 *
	 ...
	 * @param string         $container name of the container
	 * @param string         $blob      name of the blob
	 * @param GetBlobOptions $options   optional parameters
	 *
	 ...
	 * @param string            $container name of the container
	 * @param string            $blob      name of the blob
	 * @param DeleteBlobOptions $options   optional parameters
	 *
	 * @return void
	 *
	 ...
	 * @param string                    $container name of the container
	 * @param string                    $blob      name of the blob
	 * @param CreateBlobSnapshotOptions $options   optional parameters
	 *
	 ...
	 * @param CopyBlobOptions $options              optional parameters
	 *
	 * @return CopyBlobResult
	 *
